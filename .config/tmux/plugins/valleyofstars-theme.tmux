...
# Pane
tmuxSetOption "pane-border-fg" "$white"
tmuxSetOption "pane-border-bg" "$black"
tmuxSetOption "pane-active-border-fg" "$green"
tmuxSetOption "pane-active-border-bg" "$black"
...
tmuxSetOption "@prefix_highlight_bg" "$green"
tmuxSetOption "@prefix_highlight_copy_mode_attr" "fg=$black,bg=$green"
...
# Right Status Bar
tmuxSetOption "status-right" "#[fg=$visual_grey,bg=$black]#[fg=$visual_grey,bg=$visual_grey]#[fg=$dark_white,bg=$visual_grey,nobold,nounderscore,noitalics]${hddWidget} #[fg=$green,bg=$visual_grey,nobold,nounderscore,noitalics]#[fg=$black,bg=$green,bold] #h "

# Left Status Bar
tmuxSetOption "status-left" "#[fg=$black,bg=$green,bold] #S #{prefix_highlight}#[fg=$green,bg=$black,nobold,nounderscore,noitalics]"
